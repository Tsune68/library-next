...
const RentalHistoryList = ({
  rentalHistory,
  showRentalUserName,
}: RentalHistoryListProps) => {
  return (
    <ul className={styles.historyList}>
      {rentalHistory.map((rental) => (
        <li key={rental.id}>
          <div className={styles.historyList_card}>
            <div>
              <div className={styles.historyList_thumbnail}>
                <Image
            ...
            <div>
              <Link
                className={styles.historyList_title}
              ...
              <p>
                借りた日：
                {new Date(rental.borrowedAt).toLocaleDateString("ja-JP", {
                  month: "long",
                  day: "numeric",
                })}
              </p>
              <p>
                返却日：
                {rental.returnedAt
                  ? new Date(rental.returnedAt).toLocaleDateString("ja-JP", {
                      month: "long",
                      day: "numeric",
                    })
                  : "貸出中"}
